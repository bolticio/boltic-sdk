...
function transformFieldDefinition(field: FieldDefinition): FieldDefinition {
  return {
    ...
    button_type: field.button_type ?? undefined,
    button_label: field.button_label ?? undefined,
    button_additional_labels: field.button_additional_labels ?? undefined,
    button_state: field.button_state ?? undefined,
    disable_on_click: field.disable_on_click ?? undefined,
